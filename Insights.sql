-- creating a cleaned table with view
...
--FINDINGS: There is a similar patterns in the no of rides by quarter with highest in Q3 then Q2, Q4 and least in Q1 for both user_type
...
-- Top 10 stations where most rides are initiated by user_type
SELECT start_station_name,
		 COUNT(*) AS no_of_rides
FROM divyride
WHERE user_type = 'casual' -- same was done for members
GROUP BY start_station_name
ORDER BY no_of_rides DESC
LIMIT 10

--Top 10 places where user_type are headed
